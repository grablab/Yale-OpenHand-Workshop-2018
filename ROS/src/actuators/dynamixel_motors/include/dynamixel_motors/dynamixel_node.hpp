...
class DynamixelNode{
	...
	ros::ServiceServer srvsrvr_set_operating_mode_, srvsrvr_cmd_pos_, srvsrvr_cmd_pos_ind_, srvsrvr_cmd_torque_, srvsrvr_cmd_torque_ind_, srvsrvr_read_pos_, srvsrvr_read_current_, srvsrvr_is_moving_;
